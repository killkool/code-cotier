  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        images: [
          { src: "/images/picto-vitesse-5-noeuds.jpg", alt: "Panneau circulaire limité à 5 nœuds au bord d'une plage, bouées jaunes en arrière-plan.", caption: "Bande des 300 m : rester à moins de 5 nœuds et utiliser les chenaux prévus. Les arrêtés locaux peuvent imposer des restrictions supplémentaires." },
        ],
      },
      {
